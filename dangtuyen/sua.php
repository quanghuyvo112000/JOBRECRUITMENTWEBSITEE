<?php 
    ...
    if(isset($_POST["submit"])) {
        ...
        isset($_POST['salary']) && isset($_POST['interview']) && isset($_POST['slogan']) && isset($_POST['id_sua'])){
            $name = $_POST['name'];
            $area = $_POST['area'];
            ...
            if (isset($noupload)){
                mysqli_query($conn,"UPDATE `dangtuyen_form` SET `id_user`='$id_user',`name_company`='$name',`slogan`='$slogan',`area`='$area',`address`='$address',
                `description`='$description',`job`='$job',`skills`='$skills',`job_detail`='$job_detail',`rank`='$rank',`exp_number`='$exp_number',`type_job`='$type_job',
                `salary`='$salary',`interview`='$interview' WHERE `id_post`= '$id_sua' ")  or die('query failed');
            }else{
                mysqli_query($conn,"UPDATE `dangtuyen_form` SET `id_user`='$id_user',`name_company`='$name',`slogan`='$slogan',`img`='$target_file',`area`='$area',`address`='$address',
                `description`='$description',`job`='$job',`skills`='$skills',`job_detail`='$job_detail',`rank`='$rank',`exp_number`='$exp_number',`type_job`='$type_job',
                `salary`='$salary',`interview`='$interview' WHERE `id_post`= '$id_sua' ")  or die('query failed');
            }
        ...
        header('location: ../dangtuyen/quanly.php?quanly');
    }
?>
        ...
        <form action="" method="post" enctype="multipart/form-data" id="cv-form">
            ...
            <div class="card">
                <div class="mb-3">
                    ...
                    <input type="number" name="id_sua" class="form-control" id="formGroupExampleInput" value="<?php echo $row['id_post']; ?>" placeholder="" readonly="true">
                </div>
                <div class="mb-3" style="display: none;">
                    ...
                    <br>
                    <div class="card">
                        <input type="file" name="fileUpload" id="fileUpload" value="<?php echo $row['img']; ?>" accept=".png, .jpg">
                    </div>
                    <br><br>
                    <?php  
                        echo $mess; 
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" class="form-control" value="<?php echo $row['name_company']; ?>"  id="formGroupExampleInput" placeholder="">
                </div>
                <div class="mb-3">
                    <label for="formGroupExampleInput" class="form-label">Slogan công ty</label>
                    <input type="text" name="slogan" class="form-control" value="<?php echo $row['slogan']; ?>" id="formGroupExampleInput">
                </div>
                <div class="mb-3">
                    <div class="form-floating">
                        <select name="area" value="<?php echo $row['area']; ?>"  class="form-select" id="floatingSelect" aria-label="Floating label select example">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="address" value="<?php echo $row['address']; ?>" class="form-control" id="formGroupExampleInput" placeholder="">
                </div>
                <br>
                <h4 class="title_card">Giới thiệu công việc</h4>
                <div class="mb-3">
                    <label for="formGroupExampleInput" class="form-label">Mô tả công việc</label>
                    <textarea name="description" value="" class="form-control" placeholder="" id="floatingTextarea2" style="height: 100px"><?php echo preg_replace('#<br\s*/?>#i', "", $row['description']); ?></textarea>
                </div>
                <div class="mb-3">
                    <div class="form-floating">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" value="<?php echo $row['skills']; ?>" name="skills" class="form-control" id="formGroupExampleInput" placeholder="" style="text-transform: uppercase;">
                </div>
                <div class="mb-3">
                    <label for="formGroupExampleInput" class="form-label"> Yêu cầu kỹ năng và chuyên môn trong công việc</label>
                    <textarea name="job_detail" class="form-control" placeholder="" id="floatingTextarea2" style="height: 100px"><?php echo preg_replace('#<br\s*/?>#i', "", $row['job_detail']); ?></textarea>
                </div>
                <div class="mb-3">
                    <div class="form-floating">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="exp_number" value="<?php echo $row['exp_number']; ?>" class="form-control" id="formGroupExampleInput">
                </div>
                <div class="mb-3">
                    <div class="form-floating">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="interview" class="form-control" id="formGroupExampleInput" value="<?php echo $row['interview']; ?>" placeholder="">
                </div>
                <br>
                <div class="mb-3">
